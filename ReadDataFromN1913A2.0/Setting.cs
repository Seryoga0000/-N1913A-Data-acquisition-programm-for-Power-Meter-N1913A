...
namespace DevicesLib
{
    public partial class Setting : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (DeviceList.Items.Count>0)
            {
                ...
                if (PMF.IniN1913A(DeviceList.Text)==1)
                {
                    ...
                    PMF.myDmm.WriteString("*IDN?");
                    MemoryFormSettingParam.LB2 = label2.Text = "IDN:   " + PMF.myDmm.ReadString();
                   ...
                   try
                   {
                       PMF.myDmm.WriteString("FETC1:POW:AC?");
                       MemoryFormSettingParam.LB9 = label3.Text = "Current Value ChanelA:  " + PMF.myDmm.ReadString();
                       //Console.WriteLine("\nSimulate:    {0}\n", driver.DriverOperation.Simulate);
                   }
                   catch
                   {
                       MemoryFormSettingParam.LB9 = label3.Text = "Current Value ChanelA:" + "-----";
                   }
                   if (PMF != null)
                   {
        ...
        public int ResolData
        {
            get
            {
                return (int)PNUD_ResolData.Value;
            }
        }
